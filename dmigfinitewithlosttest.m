function dmigfinitewithlosttest
hold off
close all
format short
...
L(m+1,m)=1/12/tao-Dp/2/h/h;L(m+1,m+1)=5/12/tao+Dp/2/h/h;L(m+1,m+2)=5/12/tao+Dc/2/h/h;L(m+1,m+3)=1/12/tao-Dc/2/h/h;
R(m+1,m)=1/12/tao+Dp/2/h/h;R(m+1,m+1)=5/12/tao-Dp/2/h/h;R(m+1,m+2)=5/12/tao-Dc/2/h/h;R(m+1,m+3)=1/12/tao+Dc/2/h/h;
for i=m+2+1:1:M+1
...
switch val
    case 1
        ...
        set(uiradio1,'value',0);
    case 2
        set(uiloststatica,'Units','normalized','Position',[0.01,0.44,0.2,0.2])
